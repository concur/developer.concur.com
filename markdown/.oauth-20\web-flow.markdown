[Source](https://developer.concur.com/oauth-20/web-flow "Permalink to OAuth 2.0 Web Flow | Developer Portal")

# OAuth 2.0 Web Flow | Developer Portal
...
Last Modified: 11/13/2014 5:15 PM PST
...
[4]: https://developer.concur.com/node/203
