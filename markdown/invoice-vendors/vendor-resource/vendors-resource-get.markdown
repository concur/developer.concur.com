[Source](https://developer.concur.com/invoice-vendors/vendor-resource/vendors-resource-get "Permalink to Vendors Resource: GET | Developer Portal")

# Vendors Resource: GET | Developer Portal
...
Last Modified: 12/13/2013 5:33 PM PST