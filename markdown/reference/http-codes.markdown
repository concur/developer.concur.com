[Source](https://developer.concur.com/reference/http-codes "Permalink to HTTP Codes | Developer Portal")

# HTTP Codes | Developer Portal
...
Last Modified: 5/6/2013 9:03 AM PDT
