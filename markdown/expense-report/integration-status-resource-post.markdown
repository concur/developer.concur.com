[Source](https://developer.concur.com/expense-report/integration-status-resource/integration-status-resource-post "Permalink to Integration Status Resource: POST | Developer Portal")

# Integration Status Resource: POST | Developer Portal
...
Last Modified: 7/12/2013 3:30 PM PDT
