[Source](https://developer.concur.com/expense-report/expense-entry-itemization-resource/expense-entry-itemization-resource-post "Permalink to Expense Entry Itemization Resource: POST")
