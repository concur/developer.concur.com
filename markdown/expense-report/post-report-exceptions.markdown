[Source](https://developer.concur.com/expense-report/expense-report-resource/post-report-exceptions "Permalink to Expense Report Resource: POST Report Exceptions")
