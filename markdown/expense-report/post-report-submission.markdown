[Source](https://developer.concur.com/expense-report/expense-report-resource/post-report-submission "Permalink to Expense Report Resource: POST Report Submission")
