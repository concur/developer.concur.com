[Source](https://developer.concur.com/expense-report/expense-form-resource/expense-form-resource-get "Permalink to Expense Form Resource: GET | Developer Portal")
