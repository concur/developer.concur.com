[Source](https://developer.concur.com/expense-report/expense-group-configuration-resource/expense-group-configuration-resource-get "Permalink to Expense Group Configuration Resource: GET")
...
Last Modified: 10/31/2013 5:03 PM PDT
