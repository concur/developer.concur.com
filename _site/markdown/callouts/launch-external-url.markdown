[Source](https://developer.concur.com/callouts/launch-external-url "Permalink to Launch External URL Callout | Developer Portal")

# Launch External URL Callout | Developer Portal
