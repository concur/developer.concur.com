[Source](https://developer.concur.com/callouts/event-notification/post-event-notification "Permalink to Post Event Notification | Developer Portal")

# Post Event Notification | Developer Portal
