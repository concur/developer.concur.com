[Source](https://developer.concur.com/travel-profile/loyalty-program-resource/loyalty-program-resource-post "Permalink to Loyalty Program Resource: POST | Developer Portal")
