[Source](https://developer.concur.com/quick-expense/quick-expense-resource/quick-expense-resource-get "Permalink to Quick Expense Resource: GET | Developer Portal")
