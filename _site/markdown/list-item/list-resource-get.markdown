[Source](https://developer.concur.com/list-item/list-resource/list-resource-get "Permalink to List Resource: GET | Developer Portal")

# List Resource: GET | Developer Portal
...
Last Modified: 4/17/2013 4:29 PM PDT
