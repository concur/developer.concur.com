[Source](https://developer.concur.com/extract/extract-definition-resource/extract-definition-resource-get "Permalink to Extract Definition Resource: GET | Developer Portal")
