...
/*
 * Altered to only handle 2 levels of headers, in order to
 * speed up toc generation. See MODIFIED for details
 */
    ...
    $.widget("toc.tocify", {
        ...
        _generateToc: function() {
            ...
            firstElem.each(function(index) {
                ...
                // MODIFIED: Filtered elements by h2 only
                $(this).nextUntil(this.nodeName.toLowerCase()).filter('h2').each(function() {

                    // MODIFIED: No nested elements, append subheaders directly
