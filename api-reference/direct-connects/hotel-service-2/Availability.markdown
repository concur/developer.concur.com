...
|  Element |	Required | Data Type 	|  Description |
|----------|-----------|---------------------------|-|
| RoomType | Y | Complex | Provides details regarding rooms, usually guest rooms. The Room Description text will be used for each room (defindd as a RoomRate) which specifies the same RoomID.|
...
| Amenitites | N | Complex | Currently not implemented.  |
...
|  Element |	Required | Data Type 	|  Description |
|----------|-----------|---------------------------|-|
| CancelPenalty | Y | Complex	| something |
