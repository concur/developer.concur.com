...
SAP Concur clients must purchase Concur Expense both or single Concur Travel in order to use this API. This API only available to approved early access partners. Please contact your SAP Concur representative for more information.
...
```shell
https://us.api.concursolutions.com/provisioning/v4/provisions/PROVISIONINGID/status?attributes=operations
```
