...
* `provisionId`: "9ff00c90-1c35-4fd1-8ac7-db8b9be70a98" is the provisioning request ID. This is a unique number that is used for querying status on the request.
...
```shell
{
    ...
    "urn:ietf:params:scim:schemas:extension:enterprise:2.0:User": {
        "employeeNumber": "John4_26_1@cs-sso-us-prod.com",
...
```shell
{
    ...
    "Operations": [
        
        {
            ...
            "value": "John_Updated_56@cs-sso-us-prod.com"
        },
        {
            "op": "replace",
            "path": "userName",
            "value": "John_Updated_76@cs-sso-us-prod.com"
        }
    ]
}
```
...
```shell
{
    "meta": {
        "resourceType": "User",
        "created": "2021-04-26T20:07:55.000097Z",
        "lastModified": "2021-04-28T15:08:21.000312Z",
        "version": 4,
        "location": "https://us.api.concursolutions.com/profile/identity/v4/Users/ef0bffaf-863f-4b3e-9c4c-bd9c9a8b2ea7",
        "statusUrl": "https://us.api.concursolutions.com/provisioning/v4/provisions/0e00f6a4-6798-4f66-9f47-1e944b619b2e/status",
        "provisionId": "0e00f6a4-6798-4f66-9f47-1e944b619b2e"
    },
    "displayName": "JohnUpdated",
    "name": {
        "familyName": "Doe",
        "givenName": "JohnUpdated",
        "formatted": "Doe, JohnUpdated "
    },
    "schemas": [
        "urn:ietf:params:scim:schemas:core:2.0:User",
        "urn:ietf:params:scim:schemas:extension:enterprise:2.0:User",
...
```
* `provisionId`: "0e00f6a4-6798-4f66-9f47-1e944b619b2e" is the provisioning request ID. This is a unique number that is used for querying status on the request.
* `id`: "ef0bffaf-863f-4b3e-9c4c-bd9c9a8b2ea7" is the SAP Concur user UUID. This is a unique number that is used for this particular user.
* `statusUrl`: The location to receive status on the provisioning request
