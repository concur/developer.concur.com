...
* [Retrieving User profile data](#get-user)
  * [Identity](#get-identity-user) | See [Identity service](https://preview.developer.concur.com/api-reference/profile/v4.identity.html) for additional infomation
  * [Spend](#get-spend-user) See [Spend service](https://preview.developer.concur.com/api-reference/user-provisioning/spend/v4.spend-user-retrieval.html) for additional infomation
  * [Travel](#get-travel-user) See [Travel service](https://preview.developer.concur.com/api-reference/user-provisioning/travel/v4.travel-extension.html) for additional infomation
...
* `travel.user.general.read`|Retrieve travel user general data: RuleClass, Groups, OrgUnit, Travel Custom Fields
* `travel.user.private.read`|Retrieve travel user private data: Sync IDs, Travel Name Remark
* `spend.user.general.writeonly`|Write access to all spend related extentions
* `spend.user.general.read`|To retrieve spend profile information
...
## <a name="#get-user"></a>Retrieving user profile data

To retrieve profile data for a specific user, Concur has has enabled seperate endpoints for the retrieval of that data. 
...
`travel.user.general.read`|Retrieve travel user general data: RuleClass, Groups, OrgUnit, Travel Custom Fields
`travel.user.private.read`|Retrieve travel user private data: Sync IDs, Travel Name Remark
`spend.user.general.read`|To retrieve spend profile data
...
GET https://us.api.concursolutions.com/profile/travel/v4/Users/
```
