...
The User Provisioning Service allows callers to provision and update a user’s profile in the SAP Concur environment. Once a user is provisioned, the users profile is available to support the Identity, Travel and Spend services.
