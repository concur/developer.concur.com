...
* [Create /Bulk using POST to provision a Request](#create-bulk-provision-post-request)
* [Create /Bulk using PATCH to provision a Request](#create-bulk-provision-patch-request)
* [Create /Bulk using PUT to provision a Request](#create-bulk-provision-post-request)
* [Using /Users to provision a Request](#create-users-provision-request)
...
## <a name="create-bulk-provision-post-request"></a>Create a POST provisioning request using the /Bulk endpoint
...
### <a name="create-bulk-provision-patch-request"></a>Create a PATCH provisioning request using the /Bulk endpoint 
...
```
### <a name="create-bulk-provision-put-request"></a>Create a PUT provisioning request using the /Bulk endpoint 
...
## <a name="retrieve-provision-request"></a>Retrieve a summary provisioning request status
...
```
## <a name="retrieve-provision-request"></a>Retrieve a detailed provisioning request status
