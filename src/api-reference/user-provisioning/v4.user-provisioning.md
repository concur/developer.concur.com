...
* [Retrieving User profile data](#get-user)
   * [Identity](#get-identity-user)
   * [Spend](#get-spend-user) 
   * [Travel](#get-travel-user)
...
### Request
```shell
GET /provisioning/v4/XXXXXXXXXXX
```

#### Request Example
```shell
GET https://www.us.api.concursolutions.com/provisioning/v4/SchemasXXXXXXXXXXXXXXXXXX
```
