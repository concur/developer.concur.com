...
* [Using the /Bulk endpoint for provisioning and managing identity data](#create-bulk-provision-post-request)
* [Using the /Users endpoint for provisioning and managing identity data](#create-users-provision-request)
...
## <a name="create-bulk-provision-post-request"></a>Using the /Bulk endpoint for provisioning and managing identity data

Creates one or more provisioning request using the /Bulk endpoint. The /Bulk endpoint supports POST, PATCH and PUT methods. 
...
### <a name="create-bulk-provision-patch-request"></a> Managing identity data with PATCH and the /Bulk endpoint 
...
```
### <a name="create-bulk-provision-put-request"></a>Managing identity data with PUT and the /Bulk endpoint 
...
## <a name="create-users-provision-post-request"></a>Using the /Users endpoint for provisioning and managing identity data
/Users endpoint for the creation or modification of single users. The /Users endpoint supports POST, PATCH and PUT methods. 
* DELETE operation is not supported at this time.  
...
### <a name="create-bulk-provision-patch-request"></a> Managing identity data with PATCH and the /Users endpoint 
...
### <a name="create-bulk-provision-patch-request"></a> Managing identity data with PUT and the /Users endpoint 
