...
The maximum file size allowed is 400kb per reqeust. 
...
#### Response Example
> This is an example of the response from a Bulk user provisoning request for illustration purposes only.
...
---|---|---|---
`attributes={parameter}`|`string`|-|Query parameters that can be used to filter, sort, and paginate to return zero or more resources in a query response.
