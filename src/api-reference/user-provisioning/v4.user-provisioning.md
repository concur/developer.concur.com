...
* [Schema](#schema)  
  ...
  * [Summary provision Status](#summary-provision-status-schema)  
  * [Detailed provision Status](#detailed-provision-status-schema) 
  * [Error](#error-schema)
...
`identity.user.coreenterprise.writeonly`|Write access to all core and enterprise extentions except externalID.|POST
`identity.user.externalID.writeonly`|When writing externalID is required.|POST
...
```shell
{
    ...
    "emails": [
        {
            "value": "John10_8_1@BravoPro7.com",
            "type": "work",
            "notifications": false,
            "verified": false
        }
    ],
    "userName": "John10_8_1@BravoPro7.com",
    "urn:ietf:params:scim:schemas:extension:enterprise:2.0:User": {
        "employeeNumber": "John10_8_1",
        "companyId": "aa076ada-80a9-4f57-8e98-9300b1c3171d"
    }
...
`state`|`string`|`state`|Can filter results based on:[pending, success, failed]
status
