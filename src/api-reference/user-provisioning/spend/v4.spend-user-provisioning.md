...
| `reimbursementType`      | `object`                                  | `ACCOUNTS_PAYABLE`, `ADP_PAYROLL`, `CONCUR_PAY`, `PAY_PAL`, `OTHER` | **Required** The reimbursement type for the user.                                                                                     |
...
| `expenseAuditRequired`              | `string`  | `NEVER`, `REQUIRED`, `ALWAYS` | Expense audit is required.                                                                             |
...
| `defaultReportPrintFormat`          | `string`  | `RECEIPTS`. `DETAILED`, `FAX` | Default expense report print type.                                                                     |
| `showTotalOnReport`                 | `boolean` | `true`/`false`                | If `true`, displays report totals on detailed report.                                                  |
| `showExpenseOnReport`               | `string`  | `ALL`, `PARENT`, `NOTHING`    | Show expenses on detailed report.                                                                      |
...
| Name    | Type     | Format                                          | Description                                            |
| ------- | -------- | ----------------------------------------------- | ------------------------------------------------------ |
| `id`    | `string` | `custom1` - `custom22`, `orgUnit1` - `orgUnit6` | The custom data field identifier.                      |
...
| Name                          | Type     | Format              | Description                                               |
| ----------------------------- | -------- | ------------------- | --------------------------------------------------------- |
| `temporaryDelegationFromDate` | `string` | Valid ISO 8601 Date | Start date for delegate's temporary approval permissions. |
| `temporaryDelegationToDate`   | `string` | Valid ISO 8601 Date | End date for delegate's temporary approval permissions.   |

### <a name="role-schema"></a>Role

| Name         | Type     | Format                      | Description                                                   |
| ------------ | -------- | --------------------------- | ------------------------------------------------------------- |
| `roleName`   | `string` | Valid spend role code       | **Required** Expense role for employee.                       |
| `roleGroups` | `string` | Valid configured role group | **Required** Group(s) to be associated with the Expense role. |
