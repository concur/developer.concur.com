...
|`EXP_CONFIG_ADMIN`|Expense Configuration Administrator|**This role is intended to be assigned to and used by SAP Concur internal staff only.**|Y|N|
...
|`SHD_CONFIG_ADMIN`|Shared Configuration Administrator|**This role is intended to be assigned to and used by SAP Concur internal staff only.**|Y|Y|
...
|`REQ_CONFIG_ADMIN`|Request Configuration Administrator|**This role is intended to be assigned to and used by SAP Concur internal staff only.**|Y|N|
...
|`INV_CONFIG_ADMIN`|Invoice(Payment) Configuration Administrator|**This role is intended to be assigned to and used by SAP Concur internal staff only.**|Y|N|
