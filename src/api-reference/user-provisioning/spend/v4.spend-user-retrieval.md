...
`spend.user.general.read` - Refer to <a href="v4.spend-user-get-started.md#scope-usage">Scope Usage</a> for full details.
...
|`itemsPerPage`|`int`|-|The number of user resources to return on a single page. Maximum: 100|
