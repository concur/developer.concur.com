...
####  <a name="app-connector-management">Application Connector Management
...
####  <a name="old-authentication">Authentication
...
##  <a name="managing-app-connectors">Managing Application Connectors
...
###  <a name="user-permission">User Permission
...
###  <a name="accessing-app-connector-reg">Accessing Application Connector Registration
...
###  <a name="registering-app-connector">Registering an Application Connector
...
###  <a name="modifying-app-connector-reg">Modifying an Application Connector Registration
...
###  <a name="deactivating-app-connector-reg">Deactivating an Application Connector Registration
