...
`IsDeleted`|`string`|-|A true/false value which indicates whether the invoice has been deleted. (Deleted invoice are retained in the system for historical purposes.).
