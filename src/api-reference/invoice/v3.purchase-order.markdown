...
The SAP Concur Purchase Order API allows you to create and update purchase orders. It also allows you to manage PO-related data for the purposes of identifying and resolving match exceptions on invoices.
...
`Status`|`string`|-|The current status of the purchase order. Status should be either Closed or Transmitted . If a value is not provided, it will default to Transmitted
