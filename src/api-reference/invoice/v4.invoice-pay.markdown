...
* [Schema](#schema)
  ...
  * [Payment Update Result](#schema-payment-patch-result)
  * [Payment Patch](#schema-payment-update)
...
```
POST https://us.api.concursolutions.com/invoice/provider-payment/v4/invoices/{invoiceId}/paymentmetadata
```
