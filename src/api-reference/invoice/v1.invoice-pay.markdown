...
## <a name="obtain-payment"></a>Obtaining payments (Get Payment API)

Payment providers use this API to get a list of payments.
...
Payment providers use this endpoint to provide updates to the status of payments.
