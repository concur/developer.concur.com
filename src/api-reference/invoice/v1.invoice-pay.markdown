...
Name|Type|Format|Description
---|---|---|---
`providerReference`|`string` (max 100)|-|Unique identifier of the payment in the payment provider's system
...
`statusMessage`|`string` (max 255)|-|description of the status *Payment provider can provide anything they want*
`paymentAdjustmentNotes`|`string` (max 255)|-|Payment adjustment notes sent by the payment provider
