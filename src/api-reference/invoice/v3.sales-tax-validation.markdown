...
|`OrgUnit1 through OrgUnit6`|`string`|-|The code from the Custom fields. These fields may not have data, depending on the configuration.
|`OrgUnit1Value though OrgUnit6Value`|`string`|-|The value from the Custom fields. These fields may not have data, depending on the configuration.
