...
* Itinerary v1 documentation is available [here](./api-reference/travel/itinerary/itinerary.html)</a>.
...
`HasOpenBookingPassive`|`boolean`|`true`/`false`|Trip has TripLink passive segments.
...
`TravelRequestID`|`string`|-|Concur's Travel Request ID
`TripLinkLocator`|`string`|-|Concur's TripLink ID
...
Name|Type|Format|Description
---|---|---|---
`AirlineCode`|`string`|-|The airline code for the accounting line.
`AmountPaid`|`string`|-|Amount paid for the accounting line.
...
`Commission`|`string`|-|Total commission on the accounting line.
`CommissionCurrency`|`string`|-|The 3-letter ISO 4217 currency code of the commission.
`ExchangedTicketNumber`|`string`|-|The ticket number used in the exchange.
`Fare`|`string`|-|The total fare for the accounting line.
`FareCurrency`|`string`|-|The 3-letter ISO 4217 currency code of the fare.
`Fopmethod`|`string`|-|Form of payment method.
`IssueDate`|`string`|-|Issue date of the account line.
`McOType`|`string`|-|The Miscellaneous Charge Order type for the accounting line.
`Tax`|`string`|-|Total tax applied to the accounting line.
`TaxCurrency`|`string`|-|The 3-letter ISO 4217 currency code for the taxes.
`TranControlNbr`|`string`|-|The control number for the accounting line transaction.
`TranPlatingNbr`|`string`|-|The plating number for the accounting line transaction.
