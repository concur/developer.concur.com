...
The endpoint provides a way for SAP Concur partners to message users and notify them. Partners will provide template details about the message they want to send, along with data to apply to the message.
