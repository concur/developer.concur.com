...
`Meals`|`string` |This parent element contains the MealCode child element that indicates the meal preference of the traveler. [See Reference](./99-reference-resource.html#air-meal-types) for possible values.|-|-|Defaults to Regular Meal
...
* For List of Available Advantage Memberships [See Reference](./99-reference-resource.html#advantage-membership-programs)
