...
The `NationalID`s parent element contains a `NationalID` child element for each included National ID. The `NationalID` element contains the following child elements:
