...
* EC1 : If the user was not found in database
* EC2: If the user is not a Company admin, if the Company ID does not match the user's Company ID
* EC3: If the user is not an Agency admin, or if Agency Company ID is null, or if Agency Company ID does not match the users Agency Company ID 
* EC4: If the Application's uuid is null, or if Application is configured not to have access to the input travel config.
