...
user.read|Read profile information|[Getting Started](/api-reference/profile/gettingStarted.html), [User API (Profile v1)](/api-reference/profile/user.html)
user.write|Read and update profile information|[Getting Started](/api-reference/profile/gettingStarted.html), [User API (Profile v1)](/api-reference/profile/user.html)
company.read|Read company profile information|[Getting Started](/api-reference/profile/gettingStarted.html), [Company API (Profile v1)](/api-reference/profile/company.html)
company.write|Read and update company profile information|[Getting Started](/api-reference/profile/gettingStarted.html), [Company API (Profile v1)](/api-reference/profile/company.html)
...
CONFIG|Understand how to post expense information according to your company's configuration|[Expense Group Configurations](/api-reference/expense/expense-report/expense-group-configurations.html), [Details](/api-reference-deprecated/version-one-one/expense-group/expense-group-configuration-resource-get.html), [Resource](/api-reference-deprecated/version-one-one/expense-group/expense-group-configuration-resource.html)
CONREQ|Use your travel profile information to get or update connection requests between Concur and travel reward program partners|[Connection Requests](/api-reference/common/connection-requests/connection-requests-resource.html), [Connection Requests 3.0](/api-explorer/v3-0/ConnectionRequests.html), [Connection Requests 3.1](/api-explorer/v3-1/ConnectionRequests.html), [Connection Requests 3.2](/api-explorer/v3-2/ConnectionRequests.html)
ERECPT|Post receipts and invoices|[Receipts v3](/api-reference-deprecated/version-three/receipts.html)
...
FOP|Access and update user form of payment information|[Form of Payment](/api-reference/travel-profile/02-form-payment-resource.html)
GHOST|Ghost Cards|[Form of Payment](/api-reference/travel-profile/02-form-payment-resource.html)
...
LIST|Use and update drop-down lists configured by your company|[List v3](/api-reference/common/list-item/v3.list-item.html), [List v3 Swagger](/api-explorer/v3-0/Lists.html), [List Item v3 Swagger](/api-explorer/v3-0/ListItems.html), [List v1](/api-reference-deprecated/version-one/list-item/), [List v1 Resource](/api-reference-deprecated/version-one/list-item/list-resource.html), [Get List of List v1](/api-reference-deprecated/version-one/list-item/list-resource-get.html), [Post New List v1](/api-reference-deprecated/version-one/list-item/list-resource-post.html)
...
TRVPRF|Access and update Concur travel profile information|[Travel Profile 2.0 Service](/api-reference/travel-profile/00-profile-services.html), [Description](/api-reference/travel-profile/01-profile-resource.html)
PASSV|Passport VISA Information|[Passport Information](/api-reference/travel-profile/01-profile-resource.html#Passports), [Visa Information](/api-reference/travel-profile/01-profile-resource.html#Visas)
COMPD|Company Details|[Company Details](/api-reference/travel-profile/01-profile-resource.html#General), [Custom Fields](/api-reference/travel-profile/01-profile-resource.html#CustomFields)
EMERG|Emergency Contact Information|[Emergency Contact Information](/api-reference/travel-profile/01-profile-resource.html#EmergencyContact)
TSAI|TSA Information|[TSA Information](/api-reference/travel-profile/01-profile-resource.html#TSAInfo)
TMCSP|TMC Specific Information|[TMC Specific Information](/api-reference/travel-profile/01-profile-resource.html#General)
MEDIC|Medical Alerts|[Medical Alerts](/api-reference/travel-profile/01-profile-resource.html#General)
UNUTX|Unused Tickets|[Unused Tickets](/api-reference/travel-profile/01-profile-resource.html#UnusedTickets)
TRVPTS|Access User Balances and Post Travel Points Redemptions|[Travel Points](/api-reference/travel-profile/03-loyalty-program-resource.html)
...
USER|Add or update Concur user accounts|[User v1](/api-reference/user/), [User v3](/api-explorer/v3-0/Users.html), [User v3.1](/api-reference/authentication/get-users31.html)
COMPANY|Add or update Concur company accounts|Not Avaliable
locate.location.read|This allows the application to only to view the concur locate user location|[User Location API](/api-reference/locate/userLocations.html)
locate.location.write|This allows the application to write user location information using concur locate api service|[User Location API](/api-reference/locate/userLocations.html)
