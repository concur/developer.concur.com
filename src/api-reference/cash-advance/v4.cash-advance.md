...
201 Created
{
    ...
    "url": "https://us.api.concursolutions.com/cashadvance/v4/cashadvances/C0550587A7D7DF4AB41CA8EF72F6F3D1"
}
```
...
`exchangeRate`|`number`|-|The exchange rate that applies to the expected expense.If not exchange rate is provided system exchange rate will be considered. Maximum characters: 23
