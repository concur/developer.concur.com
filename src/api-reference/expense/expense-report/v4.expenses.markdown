...
|---|---|---|---|
|`userID`|`string`|-|**Required** The unique identifier of the SAP Concur user. Use [Identity v1.0 API](/api-reference/profile/v4.identity.html) to retrieve the `userID`. |
