...
* [Approve/Sendback a report](#approve-or-send-back-a-report)
* [Schema](#schema)
...
204 No Content
```
## <a name="approve-or-send-back-a-report"></a>Approve/Sendback a report

Approve API - Advances the specified report to the next step if it is in a system step
Sendback API - Sends back the specified report to report owner 
