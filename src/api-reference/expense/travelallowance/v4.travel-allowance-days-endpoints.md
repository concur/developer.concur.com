...
* [Schema](#schema)
  * [Get Travel Allowance Days Response](#schema-get-travel-allowance-days)
  * [Error](#schema-error)
...
This API requires the [Expense Report v3](/api-reference/expense/expense-report/reports.html) API, to get the report ID associated with the travel allowance items. 
...
`ContextId`|`string`|-|**Required** For Expense Reports, the report ID of the report is provided as `ContextId`.
...
travelallowance/allowancedays/companyUUID/d5528866-51b1-40a1-bab2-76296a106dcd/contexts/EXPENSE_REPORT/B769E8B106C04F30AE27
...
### <a name="schema-get-travel-allowance-days"></a>Get Travel Allowance Days Response
...
Name|Type|Format|Description
---|---|---|---
<a name="definition-dateTime"></a>`dateTime`|`string`|-|DateTime of the transaction in the format specified in ISO 8601, using UTC + Offset. For example, 2016-04-22T12:20+0700 (12:20 PM in Pacific Time).
