...
SAP Concur clients must purchase Concur Expense in order to use this API. This API requires an additional SAP Concur API that is currently only available to approved early access partners. Please contact your SAP Concur representative for more information.
