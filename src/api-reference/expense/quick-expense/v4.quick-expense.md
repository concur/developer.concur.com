...
```shell
POST https://us.api.concursolutions.com/quickexpense/v4/users/184dd31a-f48a-4103-879f-c8d45456c7cd/context/TRAVELER/quickexpenses
Accept: application/json
Authorization: Bearer {access_token}
Content-Type: application/json
concur-correlationid: quick-expense-test
```
...
```shell
POST https://us.api.concursolutions.com/quickexpense/v4/users/184dd31a-f48a-4103-879f-c8d45456c7cd/context/TRAVELER/quickexpenses/image
Authorization: Bearer {access_token}
Content-Type: multipart/form-data
concur-correlationid: quick-expense-with-image
content-type: multipart/form-data
fileContent=@/Users/i845500/Pictures/Snip20180410_1.png
```
...
`id`|`string`|-|The unique identifier of the location. Use [Locations v3.0](/api-reference/common/locations/locations-resource.html) to retrieve the location `id`.
