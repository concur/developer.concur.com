...
**Editing note:** Placeholder for diagram (To be created into diagram -- if needed)
...
|---|---|---|---|
|`content`|[`ListResponse`](#schema-list-response)|-|-|-|

### <a name="schema-list-response"></a>List Response

|Name|Type|Format|Description|
|---|---|---|---|
|`id`|`string(uuid)`|`uuid`|-|Unique identifier of a list.|
|`value`|`string`|-|Name of the list.|
|`categoryId`|`string(uuid)`|`uuid`|Unique identifier of a category.|
...
|`categoryId`|`string(uuid)`|`uuid`|The unique identifier of the category that the list belongs to.|
...
|Name|Type|Format|Description|
|---|---|---|---|
|`error`|[`Message`](#schema-message)|-|**Required**|
|`httpStatus`|`string`|-|**Required** The http response code and phrase for the response|
|`path`|`string`|-|**Required** The URI of the attempted request.|
|`timestamp`|`string`|`date-time`|**Required** The time when the error was captured.|
|`validationErrors`|[`ValidationError`](#schemavalidationerror)|-|The validation error messages.|
