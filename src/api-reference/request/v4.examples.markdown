...
```json
{
  ...
  "operations": [
    {
      "rel": "submit",
      "href": "https://us.api.concursolutions.com/v4/requests/CED5E9CD8FC1424488F9331ACF956E73/submit{?companyId}"
    }
  ]
}
```
...
#### GET /v4/requests
```
curl -X GET https://us.api.concursolutions.com/travelrequest/v4/requests?view=ALL&limit=10&start=0 --header 'Accept: application/json' --header 'Authorization: Bearer {token}'
```
...
```json
{
  ...
  "operations": [
    {
    "rel": "submit",
    "href": "https://us.api.concursolutions.com/v4/requests/224AF3CDCC2A5244A37C72FA5770C6F2/submit{?companyId}"
    }
  ]
}
```
...
```json
{
  ...
  "operations": [
    {
      "rel": "submit",
      "href": "https://us.api.concursolutions.com/v4/requests/053A479B3C9DD847B02A203C657AE26B/submit{?companyId}"
    }
  ]
}
```
...
```json
{
  ...
  "operations": [
    {
      "rel": "recall",
      "href": "https://us.api.concursolutions.com/v4/requests/053A479B3C9DD847B02A203C657AE26B/recall{?companyId}"
    },
    {
      "rel": "cancel",
      "href": "https://us.api.concursolutions.com/v4/requests/053A479B3C9DD847B02A203C657AE26B/cancel{?companyId}"
    }
  ]
}
```
