...
approver|object|[Employee](#schema-employee)|The approver to whom the Request was sent to
...
highestExceptionLevel|string|-|The highest level of exception contained in this Request. <br>Possible values: `WARNING`, `ERROR`
