...
totalApprovedAmount|object|[Amount](#amount)|The total amount of approved expected expenses in the Request, expressed in the reimbursement currency of the employee at the time he created the Request
...
creationDate|path|timestamp|[RFC 3339](https://tools.ietf.org/html/rfc3339)|Creation date of the comment (in the format yyyy-MM-dd'T'HH:mm:ss.SSS)
isLates|boolean|path|-|True when the comment has been edited since the last workflow transition
value|path|string|-|The value of the comment
...
lastModifiedDate|timestamp|[RFC 3339](https://tools.ietf.org/html/rfc3339)|The date when this expected expense was last modified
