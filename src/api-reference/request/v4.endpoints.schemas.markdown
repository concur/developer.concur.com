...
`highestExceptionLevel`|`string`|-|The highest level of exception contained in this Request. Supported values: `WARNING`, `ERROR`, `NONE`
...
Name|Type|Format|Description
---|---|---|---
`code`|`string`|-|The code for the approval status of the cash advance. Supposed values: `C_PEND`, `C_APPR`, `C_COMP`, `C_FILE`, `C_ISSU`, `C_NISU`, `C_NOTF`, `C_PECA`, or `C_REJE`
...
`type`|`string`|-|Defines the type of the source. Supported values are: `ALLOCATION`, `CASH_ADVANCE`, `EXPENSE`, `HEADER`
...
Name|Type|Format|Description
---|---|---|---
`operation`|`string`|-|Exchange rate operation. Supported values: `MULTIPLY` or `DIVIDE`
...
`proposalType`|`string`|-|The travel agency proposal type. Supported values: `CWTF`, `AEBT` or `API`
