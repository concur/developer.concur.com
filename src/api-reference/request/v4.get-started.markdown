...
SAP Concur clients must purchase Concur Request in order to use this API. This API requires the following additional SAP Concur APIs to be called by the SAP Concur Clients:
...
* [List], to retrieve the `listId` - required in the management of custom fiels related to list items. In externalisation process, please liaise with List API owner team for further update
