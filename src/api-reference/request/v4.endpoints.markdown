...
To learn more about request headers and response HTTP status codes and headers for this API see [Travel Request v4 - HTTP Status Codes](./v4.response-codes.html).
...
[Request](#schema-request) - The list of Request(s) meeting the values set in the parameters
