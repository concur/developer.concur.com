...
To learn more about request response HTTP status codes for this API see [Travel Request v4 - HTTP Status Codes](./v4.response-codes.html).
...
extensionOf|object|[RequestLink](#schema-requestlink)|The Request that this Request is an extension of, or adendum to
...
mainDestination|object|[Location](#schema-location)|The main destination of the Request
...
totalApprovedAmount|object|[Amount](#schema-amount)|The total amount of approved Expenses in the Request, expressed in the reimbursement currency of the employee at the time he created the Request
totalPostedAmount|object|[Amount](#schema-amount)|The total amount of the Request, expressed in the reimbursement currency of the employee at the time he created the Request
totalRemainingAmount|object|[Amount](#schema-amount)|The total amount not included in an Expense report, expressed in the reimbursement currency of the employee at the time he created the Request
...
orgUnit1 to orgUnit6|object|[Amount](#schema-amount)|The details from the Custom fields. <br>These fields may not have data, depending on the configuration
