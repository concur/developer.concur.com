...
To learn more about request headers and response HTTP status codes and headers for this API see [Travel Request v4 - HTTP Status Codes](./v4.response-codes.html) and [Travel Request v4 - Headers](./v4.headers.html).
...
[List of Request](#listofrequests)
...
[Expense](#expense) - List of entries attached to a Request.
...
### <a name="listofrequests"></a>List of Requests

Name|Type|Format|Description
---|---|---|---
data|array|[Request](#request)|List of Requests in the page requested
operations|array|[Link](#link)|Links to next, prev, first and last pages
