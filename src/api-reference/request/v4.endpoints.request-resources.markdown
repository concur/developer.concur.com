...
Name|Parameter Type|Data Type|Description
---|---|---|---
view|path|string|Name of the perimeter defining the requests to get.<br> Possible values: 
...
---|---|---|---
author|object|[Employee](#schema-employee)|The employee who has created the comment in the Request Header
creationDate|timestamp|[RFC 3339](https://tools.ietf.org/html/rfc3339)|Creation date of the comment (in the format yyyy-MM-dd'T'HH:mm:ss.SSS)
isLates|boolean|-|True when the comment has been edited since the last workflow transition
