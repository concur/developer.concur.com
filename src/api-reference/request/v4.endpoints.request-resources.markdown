...
userId|query|string|The unique identifier of the user getting the content of the Request. <br>If empty when using a Company token the default system user will be assumed to perform the action.
