...
* Receipts currently can't be Posted to users whose data is hosted in the SAP Concur EU datacenter. Only users whose data is hosted in the US datacenter can receive e-receipts.
