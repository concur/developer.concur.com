...
|mapUrl|string|[Google Maps URI Pattern](#google-maps-uri-template)|Link to an image of the traveled route.|
|__*pickupLocation*__|object|[Location](#location)|Schema representing a location, including geographical information and a postal address. Used in multiple receipt types.|
...
<a name="google-maps-uri-template"></a>Google Maps URI Pattern: `^https://(www|maps).(googleapis|google).[a-z]+/maps/`
