...
`connectedListSequenceNumber`|`integer`|-|Indicates the level of the budget tracking field in a connected list. **READ ONLY**
`fieldDefinitionId`|string|-|The budget service's key for this object's field definition id.
