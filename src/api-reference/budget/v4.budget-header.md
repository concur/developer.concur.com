...
`id`|`string`|-|The unique identifier for the budget item.
...
`featureTypeCode`|`string`|-|The feature type for this balance. Supported values: `REQUEST`, `TRAVEL`, `EXPENSE`, `PAYMENT_REQUEST`.  **READ ONLY**
