...
This Web Service provides an automated solution to request available data objects such as approved expense reports, cash advances, and invoices to import to the client internal system, with an opportunity to send posting confirmation back into SAP Concur before the object is locked down and cannot be altered in SAP Concur.
...
* [Get a List of Financial Transactions](#get-transactions)
...
---|---|---
N/A|Read financial transactions and write financial transaction status|GET, POST
...
## <a name="post-acknowledgements"></a>Post a Financial Transaction Acknowledgement
...
> This response shows both success and failure <a hred="#service-codes">service code</a> examples.
