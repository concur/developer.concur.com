...
[**JSON Example**](./FI-API-ReportID-B1041655B4CE4171BDAA-Example-1.1.json)
...
[**JSON Example**](./FI-APIReportID-6517F735E33A47B98D80-Example-1.2.json)
...
[**JSON Example**](./FI-API-ReportID-473498AF26AE45A094A6-Example-1.3.json)
...
[**JSON Example**](./FI-API-ReportID-AA45D472EC0D456D9D73-Example-1.4.json)
...
[**JSON Example**](FI-API-ReportID-F071FADEA6B142DD884A-Example-2.1.json)
...
[**JSON Example**](FI-API-ReportID-641C4F998328438284A2-Example-2.2.json)
...
[**JSON Example**](FI-API-ReportID-0EE74C75C9344DEA942F-Example-2.3.json)
...
[**JSON Example**](FI-API-ReportID-FABA2A8599224AE5A6C8-Example-2.4.json)
...
[**JSON Example**](FI-API-ReportID-2519BED4A22B43C4B8E7-Example-2.5.json)
...
[**JSON Example**](FI-API-ReportID-0C45F960C3064ED88C39-Example-3.1.json)
...
[**JSON Example**](FI-API-ReportID-460EFDDC98634EA9A0AD-Example-4.1.json)
...
[**JSON Example**](FI-API-CashAdvanceID-E2A086D30B88AE4683BC48ADE47B8116-Example-5.1.1.json)
...
[**JSON Example**](FI-API-CashAdvance-ID-2E6DA12BB8B87D468BD666383E44033D-Example-5.2.1.json)

[**Standard Accounting Extract**](./v4.financial-integration-use-cases-extract-information.html#ecailtca)

[**JSON Example**](FI-API-Report-ID-14A40453BED6493EB53F-Example-5.2.1.json)
...
[**JSON Example**](FI-API-CashAdvance-ID-30D6B657B6A50946AC6C2DAB537C8CD9-Example-5.2.2.json)

[**Standard Accounting Extract**](./v4.financial-integration-use-cases-extract-information.html#ecaihtca)

[**JSON Example**](FI-API-Report-ID-52F40A7F26D74F1AAFFB-Example-5.2.2.json)
...
[**JSON Example**](FI-API-ReportID-B1041655B4CE4171BDAA-Example-6.1.1.json)
...
[**JSON Example**](FI-API-ReportID-CDFDE0F4CACE4426A913-Example-6.1.2.json)
...
[**JSON Example**](FI-API-ReportID-57A29232093E4B7AADF7-Example-6.1.3.json)
...
[**JSON Example**](FI-API-ReportID-0C45F960C3064ED88C39-Example-6.1.4.json)
...
[**JSON Example**](FI-API-ReportID-4B643D954FF64AF0B771-Example-6.1.5.json)
...
[**JSON Example**](FI-API-ReportID-1B25850DD8B94D5F8B2D-Example-6.1.6.json)
...
[**JSON Example**](FI-API-ReportID-7E141428931340B990A3-Example-6.1.6-with-offsetting.json)
...
[**JSON Example**](FI-API-ReportID-EEBD898C643A40DEB4E9-Example-6.1.7.json)
...
[**JSON Example**](FI-API-ReportID-9AAA32338A264AC1908E-Example-6.1.7-with-offsetting.json)
...
[**JSON Example**](FI-API-ReportID-15298B27B5FC4EBC98B3-Example-6.2.1.json)
...
[**JSON Example**](FI-API-ReportID-815EF4FB5B4448A9B09E-Example-6.2.2.json)
...
[**JSON Example**](FI-API-ReportID-9616BC579E7246D8BDB9-Example-6.2.3.json)
...
[**JSON Example**](FI-API-ReportID-7F00502973D84DEFA49E-Example-6.2.4.json)
