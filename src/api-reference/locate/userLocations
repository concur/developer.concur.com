...
The user locations API includes users and itineraries (locations) in addition to information about the company and post type (add or cancel).
  ...
  | ---------------| --------| -------| -----------
  | _*UserLocations*_ | Object | JSON | Contains the Client, Users, Locations, Source Partner and Transaction.
  | _*Client*_  |  Object |  JSON  |  This indicates which entity within the organization the traveler belongs to.
  | _*Users*_ | Object | JSON | This is the users' information. This will be used to either create a new traveler or to match with an existing traveler.
  | _*Locations*_ |Object | JSON | This is the users' location information. Multiple locations can be passed for a single user.
  | _*SourcePartner*_ | Object | JSON | This is used to identify your application. This information will be provided to you in advance.
  | _*Transaction*_ | Object | JSON | Whether this transaction adds or cancels itineraries/locations.
...
| ---------------| -------------| -----| -----------
| _*Id*_ | 36 | String| Id: This maps to the top-level agency (corporation).
...
| lastName | 100 | String |
| email | 255 | String |
| employeeId | 19 | String | Either employeeId or concurLoginId must be provided.
| mobileCountryCode | 3 | String |
| mobile | 10 | String |
| optedIn | 'True' / 'False' | String |
| concurLoginId | 128 | String | Either employeeId or concurLoginId must be provided.
...
### Transaction
Itineraries can be added or cancelled. This section allows you to indicate whether this is an addition of a new itinerary or cancellation of an existing itinerary.

| transactionId | 5 | String | This is a unique identifier generated by your application for the request.
