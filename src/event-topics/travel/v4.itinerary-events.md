...
`ItineraryAonymized`|Published when an existing trip is anonymized due to company's data retentation policy or user gets deleted or purged sensitive data.
