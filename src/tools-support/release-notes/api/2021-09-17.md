...
As part of the Feature parity project to externalize the Request v4 API, a temporary Request cash advance detail endpoint was developed, awaiting the general availability of the Cash Advance v4 API, planned end of September 2021.
...
The addition of the new ACTIVEAPPROVED view parameter will enable to restrict the list of Request to approved Requests for a given traveler. This business case was initially raised by Concur Expense product, at Concur we considered that this feature will also benefit for our consumers and have chosen to set this parameter as public.
