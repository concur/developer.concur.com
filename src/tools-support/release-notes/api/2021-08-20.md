...
Please find more information on the List Item API within the API Reference pages.
...
As part of the Feature parity project to externalize the Request v4 API, the Request cash advance detail endpoint was developed temporarily, awaiting the general availibility of the Cash Advance v4 API, coming soon.

Effective in the beginning of October 2021, the Request cash advance list endpoint will redirect consumers to the Retrieve a Cash Advance endpoint, part of the Cash Advance v4 API. This endpoint is feature parity with the temporarily Request endpoint, consumers will in addition benefit from additional fields provided within the Cash Advance v4 API.
