...
* [Expense v4 API Event Subscription Service Topic Available](#planned-expense-ess)
...
This new endpoint will provide added value to the existing Request v4 APIs panel, which already offer the ability for a user to interact with Concur Request to perform the following:
